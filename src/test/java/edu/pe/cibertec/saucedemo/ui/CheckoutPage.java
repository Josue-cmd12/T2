...
public class CheckoutPage {
    public static final String BOTON_CHECKOUT = "[data-test='checkout']";
    public static final String BOTON_CONTINUE = "[data-test='continue']";
    public static final String BOTON_FINISH = "[data-test='finish']";
    ...
    public static final String CHECKOUT_CONTAINER = "[data-test='checkout-info-container']";
